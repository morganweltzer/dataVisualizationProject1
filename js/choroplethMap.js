...
//   choroplethMap.updateVis(updatedValue);
...
class ChoroplethMap {
  ...
  initVis() {
    ...
    vis.counties = vis.g.append("g")
                ...
                .attr('fill', d => {
                      if (
                        d.properties.poverty_perc !== undefined &&
                        d.properties.poverty_perc !== -1
                      )  {
    ...
    // });
      ...
      vis.counties
                .on('mousemove', (d,event) => {
                  console.log(d);
                  console.log(event);
                    const povPerc = d.properties.poverty_perc ? `<strong>${d.properties.poverty_perc}</strong> Poverty Percent<sup>2</sup>` : 'No data available'; ; 
                    d3.select('#tooltip')
                      .style('display', 'block')
